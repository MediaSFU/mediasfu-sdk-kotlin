...
data class EventSettingsModalOptions(
    ...
    val onUpdatePermissionConfig: ((PermissionConfig) -> Unit)? = null,
    val onApplyTranslationSettings: ((String, Boolean, String?, String?, Map<String, String>, Boolean) -> Unit)? = null,
    ...
    val translationConfig: TranslationRoomConfig? = null,
    val mySpokenLanguage: String = "",
    val mySpokenLanguageEnabled: Boolean = false,
    val myDefaultOutputLanguage: String? = null,
    val myDefaultListenLanguage: String? = null,
    val participants: List<Participant> = emptyList(),
    val listenPreferences: Map<String, String> = emptyMap(),
    val translationChannelsBySpeaker: Map<String, List<String>> = emptyMap(),
    val showTranslationSubtitles: Boolean = true,
